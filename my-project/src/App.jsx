  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-1 lg:pt-0 pt-12'>
        <h1 className=' animate-text bg-gradient-to-r from-pink-600 via-yellow-500 to-orange-500 bg-clip-text text-transparent lg:text-5xl md:text-6xl text-5xl font-black p-1'>R45 AI</h1>
        <h3 className='lg:text-lg md:text-xl text-sm'>Transform your ideas into <span className='text-pink-500'>Reality</span></h3>
        <br />
